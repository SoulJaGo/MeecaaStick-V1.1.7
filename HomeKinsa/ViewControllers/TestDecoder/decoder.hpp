...
public:
    Decoder(INT32 recordBufSize, INT32 fs, INT32 msgBufSize)
    {
        ...
        fPointsPerSymbol = 0.0005635865457294029 * fs;    //fs * SYMBOL_WIDTH_TIME;
        ...
        // After serials of test, 12 is enough to synchronize the idle bits
        syncSymbolNum = 12;
        ...
        // points in 70mS
        infoPoints = (INT32)(INFO_LENGTH_TIME * fs + 1);
